...
repositories, issues, pull requests, Discussions, and any other project
channel — and also applies when an individual is officially representing the
...
### 1. Correction
**Impact**: Use of inappropriate language or other behaviour deemed
