...
TOOL_CATEGORIES_BY_NAME: dict[str, str] = {
    ...
    "routine_list": "automation",
    "routine_create": "automation",
    "routine_update": "automation",
    "routine_pause": "automation",
    "routine_delete": "automation",
    "goal_list": "automation",
    "goal_create": "automation",
    "goal_view": "automation",
    "goal_pause": "automation",
    "goal_resume": "automation",
    "goal_abort": "automation",
...
_TOOL_SEARCH_INDEX = {
    ...
    "schedule": ["schedule_task", "list_cron", "remove_cron",
                 "routine_list", "routine_create", "routine_update", "routine_pause", "routine_delete"],
    "cron": ["schedule_task", "list_cron", "remove_cron",
             "routine_list", "routine_create", "routine_update", "routine_pause", "routine_delete"],
    "routine": ["routine_list", "routine_create", "routine_update", "routine_pause", "routine_delete"],
    "routines": ["routine_list", "routine_create", "routine_update", "routine_pause", "routine_delete"],
    "reminder": ["routine_list", "routine_create", "routine_update", "routine_pause", "routine_delete",
                 "schedule_task", "set_timer"],
    "goal": ["goal_list", "goal_create", "goal_view", "goal_pause", "goal_resume", "goal_abort"],
    "goals": ["goal_list", "goal_create", "goal_view", "goal_pause", "goal_resume", "goal_abort"],
    "task": ["goal_list", "goal_create", "goal_view", "goal_pause", "goal_resume", "goal_abort",
